...
class ChannelManager:
    ...
    def _init_channels(self) -> None:
        ...
        if self.config.channels.telegram.enabled:
            try:
                from aigernon.channels.telegram import TelegramChannel
        ...
        if self.config.channels.whatsapp.enabled:
            try:
                from aigernon.channels.whatsapp import WhatsAppChannel
        ...
        if self.config.channels.discord.enabled:
            try:
                from aigernon.channels.discord import DiscordChannel
        ...
        if self.config.channels.feishu.enabled:
            try:
                from aigernon.channels.feishu import FeishuChannel
        ...
        if self.config.channels.dingtalk.enabled:
            try:
                from aigernon.channels.dingtalk import DingTalkChannel
